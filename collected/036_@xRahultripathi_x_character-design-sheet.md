...
生成日系 kawaii 风格可爱女性角色设计表（character sheet），包含正面头像特写、6 种表情变化、2-3 个全身姿势、配饰图标、色板区域、角色信息档案框，半写实卡通风格柔和色调，动画角色设定文档布局。

## 标签

character-design, character-sheet, kawaii, anime, cute, female-character, design-sheet, expression-set, color-palette, Japanese, pastel, semi-realistic

## 图片样例

- ![样例 1](https://pbs.twimg.com/media/HHObKobbQAAc2pf?format=jpg&name=small)
