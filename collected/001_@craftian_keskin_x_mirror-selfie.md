...
- **来源**: [@craftian_keskin](https://x.com/craftian_keskin/status/2047046373401301055)
- **采集时间**: 2026-05-02
- **Prompt 位置**: 主推文
...
```json
{
  ...
  "Scene": {
    "location": "stylish restroom or dressing area with bold red textured walls",
    "mirror": "large circular mirror",
    "background_elements": [
  ...
  "Subject": {
    ...
    "clothing": {
      "top": "black off-shoulder long sleeve top with deep neckline",
      "bottom": "high-waisted dark jeans"
    }
  },
  "Photography": {
...
生成带强烈手机闪光灯效果的镜面自拍照片，模拟真实手机前摄在镜子中的反光效果，包含镜头光晕、噪点和动态范围等手机相机特征。

## 标签

mirror-selfie, phone-photography, direct-flash, nightlife, photorealism, JSON-structured

## 原始文本

New GPT Image 2.0 is good!

GPT Image 2.0 vs Nano Banana Pro. Who wins?
