...
- **来源**: [@0xInk_](https://x.com/0xInk_/status/2048809000121360649)
- **采集时间**: 2026-05-04
- **Prompt 位置**: 博主评论
- **搜索词**: gpt-image-2 pixel art indie game character
- **组**: 072
...
STYLEHyper-realistic CGI. White void sections: clean, minimal, studio-lit. Gameplay section: dense Cyberpunk 2077 / Assassin's Creed open-world density, golden hour lighting, wet reflections, volumetric haze. Seamless transition from sterile UI to living world. No cuts, one continuous camera move.
SOUNDUI sections: clean digital clicks, mechanical servo sounds, subtle electronic hum. Loading transition: rising bass drone. Gameplay reveal: full ambient soundscape floods in city noise, distant bass music, footstep splashes.

## 用途

使用 GPT Image 2 生成游戏预告片风格的角色设定图，从极简白色 UI 环境过渡到赛博朋克开放世界，包含角色自定义界面、加载画面和游戏内场景的完整视觉序列。

## 标签

game-trailer, cinematic, cyberpunk, character-design, game-UI, CGI, open-world, hyper-realistic

## 图片样例

- ![样例 1](https://pbs.twimg.com/media/HG7FpQLaoAAaGta?format=jpg&name=360x360)
- ![样例 2](https://pbs.twimg.com/media/HG7FyzVaAAAa8U3?format=jpg&name=360x360)
- ![样例 3](https://pbs.twimg.com/media/HG7F9GuaYAAkfwG?format=jpg&name=360x360)
- ![样例 4](https://pbs.twimg.com/media/HG7GeDzbEAEt-lS?format=jpg&name=360x360)

## 原始文本

Step 4: I use Claude to help me write the prompt

Here's the one I used for my video
...
I also used DaVinci for editing and Topaz to enhance the quality and increase the frame rate
