...
- **来源**: [@TechieBySA](https://x.com/TechieBySA/status/2013316513701216688)
- **采集时间**: 2026-05-03
- **Prompt 位置**: 博主评论
...
生成任意物品的技术信息图（替换 [OBJECT]），在写实渲染物体上叠加黑白技术标注，含组件标签、剖面图、尺寸标注和功能箭头，纯黑白配色，博物馆展品/工程手册风格，1080x1080 方形输出。

## 标签

infographic, technical-annotation, black-ink, architectural-sketch, cutaway-diagram, exploded-view, museum-exhibit, engineering-manual, no-color, 1080x1080, template

## 图片样例

- ![样例 1](https://pbs.twimg.com/media/G_C8sj-XEAEUN6X?format=jpg&name=small)
