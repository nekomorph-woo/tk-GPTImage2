...
生成多格彩色中文漫画，讲述 OpenAI 研究员陈博远改进 GPT Image 2 中文渲染能力的故事，包含叙事分镜、人物表情、极小中文字渲染测试和幽默反转，1440x2560 竖版布局，模拟实体漫画书页面质感。

## 标签

manga, Chinese-text, multilingual, storytelling, vertical-layout, 1440x2560, OpenAI, humor, easter-egg, ultra-small-text, physical-page
...
GPT Image 2 Prompt：Chinese comic
Source：https://openai.com/index/introducing-chatgpt-images-2-0/…

-- prompt ---

Generate a full color Chinese-text manga about this OpenAI research scientist...
```

<--- End of preview --->
```

> 注意：原文较长，此处省略部分内容。完整 prompt 见上方 Prompt 节。
