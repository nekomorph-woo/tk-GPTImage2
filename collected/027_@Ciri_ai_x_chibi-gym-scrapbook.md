...
"lift strong" / "stronger every rep" / "no pain no gain" / "sweat now, shine later" / "progress over perfection" / "train hard, stay soft"
...
在原始健身房照片上叠加 chibi 风格迷你分身和手绘涂鸦装饰，保持原图完全不变，添加多个 Q 版小人做不同健身动作，白粉手写字体励志短语，剪贴簿风格。

## 标签

chibi, image-edit, gym, scrapbook, doodles, handwritten-notes, motivational-quotes, mini-characters, feminine, fun, energetic, fitness

## 图片样例

- ![样例 1](https://pbs.twimg.com/media/HHNmApKacAAp9rE?format=jpg&name=small)
- ![样例 2](https://pbs.twimg.com/media/HHNmApZaEAAwWYy?format=jpg&name=360x360)

## 原始文本

GPT Image 2 on Chatgpt

Prompt: Edit the image while keeping the original photo completely unchanged...
```
