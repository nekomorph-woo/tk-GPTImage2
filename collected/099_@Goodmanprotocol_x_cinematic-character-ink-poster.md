...
- **采集时间**: 2026-05-04
- **Prompt 位置**: 正文
- **搜索词**: product advertising poster design
...
生成电影角色宣传海报模板（9:16 竖版），东亚水墨美学 + 高端视觉叙事风格，上重下轻层级布局：上半部大尺寸角色剪影（头部/面部/上半身），中下部全身像，剪影内部和周围双层曝光拼贴叙事（关键场景、象征意象、叙事人物），云雾墨染留白融合，大面积负空间营造东方意境平衡。

## 标签

character-poster, cinematic, east-asian-aesthetic, ink-wash, 9:16, double-exposure, collage-storytelling, silhouette, negative-space, hierarchical-layout, premium, template-prompt, atmospheric

## 图片样例

- ![样例 1](https://pbs.twimg.com/media/HG-ErIdaoAAsW6q?format=jpg&name=large)
- ![样例 2](https://pbs.twimg.com/media/HG-ErMEbAAAkGN7?format=jpg&name=large)
- ![样例 3](https://pbs.twimg.com/media/HG-ErQobUAAiuPn?format=jpg&name=large)
- ![样例 4](https://pbs.twimg.com/media/HG-ErV5aMAA6V0x?format=jpg&name=large)
- ![样例 5](https://pbs.twimg.com/media/HHDBOyHaQAAmunL?format=jpg&name=large)
- ![样例 6](https://pbs.twimg.com/media/HG_uNgOXIAAMPPK?format=jpg&name=large)

## 原始文本

Keep it real - is this fire or mid?
