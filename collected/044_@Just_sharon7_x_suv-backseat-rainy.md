...
生成雨天豪车后座随拍风格人像，年轻女性休闲自信姿态，红白学院风毛衣+Burberry格纹+海军蓝棒球帽，黑色真皮座椅+全景天窗，车窗雨滴城市背景，iPhone 快照质感非摆拍，JSON 结构化参数精确控制。

## 标签

luxury-SUV, backseat, candid, iPhone-photography, rainy, streetwear, varsity-sweater, off-duty-model, realistic, 3:4-view, JSON-prompt
...
It's raining in my area

GPT Image 2

{ "prompt": { "subject": "young woman seated in luxury SUV backseat..." } }
```
