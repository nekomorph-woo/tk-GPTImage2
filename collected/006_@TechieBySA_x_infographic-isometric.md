...
生成任意物品（替换 [OBJECT]）的等距 3D 技术信息图，结合写实渲染与黑白技术标注，包含组件标签、剖面图、尺寸标注和功能流程箭头，类似博物馆展品级产品拆解手册风格。

## 标签

infographic, isometric-3D, technical-annotation, product-teardown, cutaway-diagram, color-coded-arrows, architectural-linework, museum-exhibit, 1080x1080, template

## 图片样例

- ![样例 1](https://pbs.twimg.com/media/HGv38XFawAAbT6V?format=jpg&name=small)
- ![样例 2](https://pbs.twimg.com/media/G_C8sj-XEAEUN6X?format=jpg&name=small)

## 原始文本

Tried my Infographic prompt with GPT Image 2 on @SocialSight
